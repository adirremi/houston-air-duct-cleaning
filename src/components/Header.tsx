  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-paper/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-3.5 md:px-8">
        <Link
          href="/"
          className="flex items-center gap-3 text-teal-deep"
        ...
        >
          ...
          <span className="leading-tight">
            ...
            <span className="block text-[0.68rem] uppercase tracking-[0.22em] text-teal">
              Cleaning
            </span>
          </span>
        </Link>
        ...
        <nav className="hidden items-center gap-7 md:flex" aria-label="Primary">
            ...
            return (
              <Link
                ...
                className={`text-sm tracking-wide ${
                  active ? "text-teal" : "text-ink/80 hover:text-teal"
                }`}
              >
                {item.label}
              </Link>
          ...
          <Link
            href="/locations"
            className="rounded-sm bg-teal px-3.5 py-2 text-sm text-paper hover:bg-teal-deep"
          >
            Find a location
          </Link>
        </nav>
