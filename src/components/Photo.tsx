  ...
  return (
    <section className="relative isolate overflow-hidden">
      <CoverImage
        ...
        sizes="100vw"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-teal-deep/92 via-teal-deep/78 to-teal-deep/40" />
...
export function ServicePhoto({
  ...
  return (
    <div className={`relative overflow-hidden bg-teal-deep ${className}`}>
